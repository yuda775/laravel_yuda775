                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block">
                                <img class="img-thumbnail my-auto h-100 w-auto" src="/images/login.jpg" alt="login">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h2 text-gray-900 mb-4 font-weight-bold">Welcome Back!</h1>
                                    </div>
                                    <p class="pt-5">Silahkan masuk untuk melanjutkan</p>
