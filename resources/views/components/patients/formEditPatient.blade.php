        ...
        <div class="modal-content">
            ...
            <form id="editPatientForm" method="POST">
                ...
                <div class="modal-header">
                    <h5 class="modal-title fw-bold" id="modalAddHospitalLabel">Edit pasien</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="edit_address" name="address" placeholder="Masukkan alamat pasien" required></textarea>
                    </div>
